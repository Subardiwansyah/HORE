									...
									<div class="panel-container show">
										<div class="panel-content">
											<ul class="nav nav-tabs nav-tabs-clean" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-toggle="tab" href="#tab_1" role="tab" onClick="reload_tab('sales')">
														<i class="fal fa-user mr-1 text-danger"></i>
														Sales
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-toggle="tab" href="#tab_2" role="tab" onClick="reload_tab('grafik')">
														<i class="fal fa-chart-line mr-1 text-success"></i>
														Grafik
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-toggle="tab" href="#tab_3" onClick="reload_tab('summary')">
											...
											<div class="tab-content p-3">
												<div class="tab-pane fade show active" id="tab_1" role="tabpanel">
													...
													<div class="card mb-3">
														<div class="card-body">
															<div class="form-row">
																<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: tgl">
																...
																<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																	<button type="button" class="btn btn-sm btn-primary mt-4" id="btn-tampil-2" data-bind="click: tampil_sales">
																		<i class="fal fa-search"></i>
																		Tampilkan
																	</button>
																</div>
													...
													<div id="konten_sales_kunjungan" class="konten_sales"></div>													
													<div id="konten_sales_tdk_kunjungan" class="konten_sales"></div>
												...
												<div class="tab-pane fade show" id="tab_2" role="tabpanel">
													...
													<div class="card mb-3">
														<div class="card-header bg-primary-100 py-1">
															<div class="card-title" style="font-size:13px;color:#FFFFFF">
																Daftar Jumlah Outlet Tahun <span data-bind="text: tahun"></span>
															</div>
														</div>
														<div class="card-body">
													...
													<div class="card mb-3">
														<div class="card-header bg-primary-100 py-1">
															<div class="card-title" style="font-size:13px;color:#FFFFFF">
																Daftar Jumlah Sekolah Tahun <span data-bind="text: tahun"></span>
															</div>
														</div>
														<div class="card-body">
													...
													<div class="card mb-3">
														<div class="card-header bg-primary-100 py-1">
															<div class="card-title" style="font-size:13px;color:#FFFFFF">
																Daftar Jumlah Kampus Tahun <span data-bind="text: tahun"></span>
															</div>
														</div>
														<div class="card-body">
													...
													<div class="card mb-3">
														<div class="card-header bg-primary-100 py-1">
															<div class="card-title" style="font-size:13px;color:#FFFFFF">
																Daftar Jumlah Fakultas Tahun <span data-bind="text: tahun"></span>
															</div>
														</div>
														<div class="card-body">
													...
													<div class="card mb-3">
														<div class="card-header bg-primary-100 py-1">
															<div class="card-title" style="font-size:13px;color:#FFFFFF">
																Daftar Jumlah POI Tahun <span data-bind="text: tahun"></span>
															</div>
														</div>
														<div class="card-body">
					...
					<script>
						...
						function reload_tab_sales(){
							var tgl = App.tgl() ? App.tgl() : '-';
							tgl = tgl.replace('/', '-').replace('/', '-');
							var arr_summ = ['kunjungan', 'tdk_kunjungan'];
							var arr_summ_length = arr_summ.length;

							// $('.konten_sales').load(GLOBAL_MAIN_VARS["BASE_URL"] + GLOBAL_MAIN_VARS["MODUL"] + '/get_data_blank/');

							for (var i = 0; i < arr_summ_length; i++)
							{
								$('#konten_sales_' + arr_summ[i]).load(
									GLOBAL_MAIN_VARS["BASE_URL"] + GLOBAL_MAIN_VARS["MODUL"] + '/get_data_sales_' + arr_summ[i] + '/' +
									tgl + '/'
								);
							}
						}
						...
						function reload_tab_summary(){
							...
							var arr_summ = ['branch', 'cluster', 'tap', 'kabupaten', 'kecamatan'];
							// var arr_summ = ['branch'];
							var arr_summ_length = arr_summ.length;
						...
						function lihat_pjp(id)
						{
							var tgl = App.tgl() ? App.tgl() : '-';
							tgl = tgl.replace('/', '-').replace('/', '-');

							location.href = GLOBAL_MAIN_VARS["BASE_URL"] + GLOBAL_MAIN_VARS["MODUL"] + '/form/' + id + '/' + tgl;
						}
